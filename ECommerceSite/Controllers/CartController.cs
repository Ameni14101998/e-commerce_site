...
namespace ECommerceSite.Controllers
{
    public class CartController : Controller
    {
        ...
        private readonly Data.AmeniStoreContext _context;

        public CartController(Data.AmeniStoreContext context)
        {
            _context = context;
        }
        ...
        {
            HttpContext.Response.Cookies.Append(CartCookieName, JsonConvert.SerializeObject(cartItems), new CookieOptions()
            {
